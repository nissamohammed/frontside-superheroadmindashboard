...
<img src={logo} alt="no image" width={'75px'}  height={'75px'}/>
<h2 className='mt-2 text-info fw-bolder '>Demon Slayer</h2>
</div>
      <div className="div3 p-3 mt-4 rounded-5 shadow">
        <Row>
          ...
          <h4 className='fw-bolder fs-3 px-3 ms-2'>Sign In to your Account</h4>
